// Firestore API URLs
const firestoreCustomerQueryUrl = "https://firestore.googleapis.com/v1/projects/online-shopping-fd20d/databases/(default)/documents:runQuery";
const firestoreCustomerUpdateUrl = "https://firestore.googleapis.com/v1/projects/online-shopping-fd20d/databases/(default)/documents/customer/";
...
async function updateCustomerCredit(event) {
    ...
    try {
        ...
        const updatedCustomer = {
            fields: {
                credit: { doubleValue: newCredit }
            }
        };

        // Step 2: Specify the field mask to only update the credit field

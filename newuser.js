...
const customerCollectionApiUrl = "https://firestore.googleapis.com/v1/projects/online-shopping-fd20d/databases/(default)/documents/customer";

// Firestore API URL to add a new document to the customer collection
const customerAddApiUrl = "https://firestore.googleapis.com/v1/projects/online-shopping-fd20d/databases/(default)/documents/customer";
